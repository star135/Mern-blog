...
export default function DashProfile() {
    ...
    const [updateUserSuccsess, setUpdateUserSuccsess] = useState(null);
        ...
        try {
            ...
            if(!res.ok){
                ...
                setUpdateUserError(data.message );
                 ...
                 setUpdateUserSuccsess('user profile updated successfully');
                 setFormData({});
            }
    ...
    <div className='max-w-lg w-full mx-auto  p-3'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            {currentUser.isAdmin && (
                <Link to={'/create-post'}>
                <Button
                type='button' gradientDuoTone='purpleToPink' className='w-full'>
                    Create a Post
                </Button>
                </Link>
            )}

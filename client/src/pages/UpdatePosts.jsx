        ...
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          />
            ...
            <div className='flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3'>
                ...
                <Button type='button' gradientDuoTone='purpleToBlue' size='sm' outline disabled={imageUploadProgress} onClick={handleUploadImage}>
                  {imageUploadProgress ? (
            ...
            />
            <Button type='submit' gradientDuoTone='purpleToPink' size='lg' >Update post</Button>
            {
